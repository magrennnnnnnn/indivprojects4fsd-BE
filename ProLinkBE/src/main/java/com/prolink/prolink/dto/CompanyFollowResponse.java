...
public class CompanyFollowResponse {
    ...
    public CompanyFollowResponse(Long idCompanyFollow, Long followerProfileId, String followerProfileName, Long companyProfileId, String companyProfileName, String companyProfileLocation, LocalDateTime createdAt) {
    ...
    public static CompanyFollowResponse fromDomain(CompanyFollow follow) {
        return new CompanyFollowResponse(
                follow.getIdCompanyFollow(),
                follow.getFollowerProfileId(),
                follow.getFollowerProfileName(),
                follow.getCompanyProfileId(),
                follow.getCompanyProfileName(),
                follow.getCompanyProfileLocation(),
                follow.getCreatedAt()
        );
    }
    ...
    public String getCompanyProfileLocation() {
